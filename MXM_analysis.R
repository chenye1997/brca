...
library(MXM) 
library(dplyr)
target_vector <- dag_matrix[,"BRCA1"]
mxm_model <-  mmhc.skel(dataset = dag_matrix, max_k = 2, threshold = 0.05, test = "testIndFisher", type = "MMPC")
is.dag(mxm_model$G)
mxm_dag <- plotnetwork(mxm_model$G)
